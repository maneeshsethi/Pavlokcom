//this bit of code determines what phone data appears on the home screen (Sam O)
var fone1Active = true;
var fone2Active = false;
var fone3Active = false;

// Creates the abstract structure of fading program
function fadeToN() {

	if (fone1Active == true) {
		fadeToFone2();

	} else if (fone2Active == true) {
		fadeToFone3();
	} else if (fone3Active == true) {
		fadeToFone1();
	}
}
function fadeToP() {
...
// Now we get down to technical details
function fadeToFone1() {
	fone1Active = true;
	fone3Active = false;
	fone2Active = false;
